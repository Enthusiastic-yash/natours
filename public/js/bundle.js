...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieWFzaDEwMiIsImEiOiJjbDY5YXE3MTEwMWwyM2NuMXNudm4yaDB3In0.Z0ZhjkjgNu7qnZcEx3gOtA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/yash102/cl69lwcmt003y14loj5ceoaqd',
    scrollZoom: false //   center: [-118.262081081181634, 34.056577153666765],
    //   zoom: 4,
...
var stripe = Stripe('pk_test_51LTo1uSInsgHdQKhBuDVHbHK5E0aZeSUk3AiILMxJ3u7UG5W7mxH4xwY8xwQeRSVPlS4UGC7tV5LZRu7fBgIsJLl00Gjrt7Z5z');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            form = new FormData(); // document.querySelector('.btn--green-save-data').innerHTML = 'updating...';
